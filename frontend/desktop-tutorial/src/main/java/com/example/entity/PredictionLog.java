...
public class PredictionLog {
    ...
    public PredictionLog(String cropType, String cropStage, String district,
                ...
                this(cropType, cropStage, district, latitude, longitude, farmerObservation,
                    topDisease, confidence, diagnosisType, isEscalated, language, null);
                }
                ...
                public PredictionLog(String cropType, String cropStage, String district,
                         ...
                         String farmerObservation, String topDisease,
                         Double confidence, String diagnosisType,
                         Boolean isEscalated, String language, String farmerUsername) {
